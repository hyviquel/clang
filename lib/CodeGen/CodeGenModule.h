...
public:
  ...
  class OpenMPSupportStackTy {
    ...
    struct OMPStackElemTy {
      ...
      llvm::DenseMap<const VarDecl*, llvm::DenseMap<const Expr*, const Expr*>> ReorderMap;
  ...
  public:
    ...
    llvm::DenseMap<const VarDecl *, llvm::DenseMap<const Expr*, const Expr*>> &getReorderMap() {
